    ...
    <UiContainer>
      ...
      <div class="meetup">
        <div class="meetup__content">
          ...
          <!-- Программа митапа -->
          <MeetupAgenda :agenda="props.meetup.agenda" v-if="props.meetup.agenda.length"/>
          <!-- Или при пустой программе - сообщение "Программа пока пуста..." в UiAlert -->
          <UiAlert v-else>Программа пока пуста...</UiAlert>
        </div>
        <div class="meetup__aside">
          <!-- Краткая информация о митапе -->
          <MeetupInfo :organizer="props.meetup.organizer" :date="props.meetup.date" :place="props.meetup.place"/>
